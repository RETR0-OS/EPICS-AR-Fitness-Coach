        ...
        <div className="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          ...
          <form>
            <div className="mb-4">
              ...
              <input type="text" id="name" className="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-indigo-500 dark:focus:ring-indigo-500 rounded-md shadow-sm" required />
            </div>
            <div className="mb-4">
            ...
            <button type="submit" className="w-full bg-indigo-600 dark:bg-indigo-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:bg-indigo-700 dark:hover:bg-indigo-600">Sign Up</button>
          </form>
        </div>
      </main>
    </div>
